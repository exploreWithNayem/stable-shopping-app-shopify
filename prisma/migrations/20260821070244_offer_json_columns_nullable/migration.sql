...
CREATE TABLE "new_Offer" (
    ...
    "triggerCollections" JSONB,
    "excludeProducts" JSONB,
    "excludeCollections" JSONB,
...
INSERT INTO "new_Offer" ("anchorPosition", "anchorSelector", "badge", "buttonText", "countdown", "countdownEndsAt", "countdownMinutes", "countdownMode", "countdownTitle", "createdAt", "discountType", "excludeCollections", "excludeProducts", "hideInCart", "hideTriggerProduct", "id", "items", "name", "offerIntent", "offerSource", "offerType", "placement", "publishedAt", "shopId", "showQuantityPicker", "status", "targets", "title", "triggerCollections", "triggerMode", "updatedAt") SELECT "anchorPosition", "anchorSelector", "badge", "buttonText", "countdown", "countdownEndsAt", "countdownMinutes", "countdownMode", "countdownTitle", "createdAt", "discountType", "excludeCollections", "excludeProducts", "hideInCart", "hideTriggerProduct", "id", "items", "name", "offerIntent", "offerSource", "offerType", "placement", "publishedAt", "shopId", "showQuantityPicker", "status", "targets", "title", "triggerCollections", "triggerMode", "updatedAt" FROM "Offer";
DROP TABLE "Offer";
