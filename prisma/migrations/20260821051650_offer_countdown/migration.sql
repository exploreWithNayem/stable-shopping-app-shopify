...
INSERT INTO "new_Offer" ("anchorPosition", "anchorSelector", "badge", "buttonText", "countdown", "createdAt", "id", "items", "name", "offerType", "placement", "publishedAt", "shopId", "status", "targets", "title", "updatedAt") SELECT "anchorPosition", "anchorSelector", "badge", "buttonText", "countdown", "createdAt", "id", "items", "name", "offerType", "placement", "publishedAt", "shopId", "status", "targets", "title", "updatedAt" FROM "Offer";
DROP TABLE "Offer";
